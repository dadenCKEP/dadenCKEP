...
<div class="container">
  <h1 class="mt-3 mb-5 font-weight-bold border-bottom">Works</h1>
  <div class="card">
  ...
  <div class="card">
    <img class="card-img-top" src="https://api.vrchat.cloud/api/1/file/file_de96d768-c0b6-4956-b000-f5d0423839ad/1/file" alt="World">
    <div class="card-body">
