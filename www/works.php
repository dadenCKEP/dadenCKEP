    ...
    <div class="col-lg-6 col-sm-12">
      <div class="card m-2">
        ...
        <div class="card-body">
          ...
          <p class="card-text">
            VRメタバース「<a href="https://vrchat.com/">VRChat</a>」のWorldです。Unity製です。<br>3Dモデル等の製作物もこちらに展示してあります。<br> 各種実験結果等は技術系wikiの<a href="http://vrcworld.wiki.fc2.com/">VRChat 技術メモ帳</a>に参加しています。
          </p>
        </div>
      </div>
    </div>
